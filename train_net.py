...
"""
import sys
sys.path.append('/root/paddlejob/workspace/env_run/output/haojing/MaskDINO-main-ours-sam-tiny/detectron2-main')
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if evaluator_type in ["sem_seg", "ade20k_panoptic_seg"]: # sem_seg
